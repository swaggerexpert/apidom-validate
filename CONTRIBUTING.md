# Contributing to apidom-validate
...
* In GitHub, send a pull request to `apidom-validate:main`.
...
we use the git commit messages to **generate the apidom-validate change log**.
...
Samples: (even more [samples](https://github.com/swagger-expert/apidom-validate/commits/main))
...
Thank you to all the people who have already contributed to apidom-validate!